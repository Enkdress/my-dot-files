...
require("lazy").setup({
	...
	require("kickstart.plugins.oil_git"),
	require("kickstart.plugins.oil_diagnostics"),
	require("kickstart.plugins.gitsigns"),
	require("kickstart.plugins.gitbrowse"),
	require("kickstart.plugins.baleia"),
	require("kickstart.plugins.conjure"),
	require("kickstart.plugins.harpoon"),
	require("kickstart.plugins.zen"),
	require("kickstart.plugins.eca"),
